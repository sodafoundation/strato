...
type S3Service interface {
	...
	DeleteBucketCORS(ctx context.Context, in *DeleteCORSInput, opts ...client.CallOption) (*BaseResponse, error)
}
...
func (c *s3Service) DeleteBucketCORS(ctx context.Context, in *DeleteCORSInput, opts ...client.CallOption) (*BaseResponse, error) {
...
type S3Handler interface {
	...
	DeleteBucketCORS(context.Context, *DeleteCORSInput, *BaseResponse) error
}
...
func RegisterS3Handler(s server.Server, hdlr S3Handler, opts ...server.HandlerOption) error {
	type s3 interface {
		...
		DeleteBucketCORS(ctx context.Context, in *DeleteCORSInput, out *BaseResponse) error
	}
	type S3 struct {
		s3
	}
...
func (h *s3Handler) DeleteBucketCORS(ctx context.Context, in *DeleteCORSInput, out *BaseResponse) error {
