...
type MetaObject struct {
	...
	ServerSideEncryptionEnabled bool              `json:"serverSideEncryptionEnabled" bson:"serverSideEncryptionEnabled"`
	VersionId                   int32             `json:"versionId,omitempty" bson:"versionId,omitempty"`
