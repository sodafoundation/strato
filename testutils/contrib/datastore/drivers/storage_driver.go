...
func (_m *StorageDriver) CreateFileShare(ctx context.Context, fs *file.CreateFileShareRequest) (*file.CreateFileShareResponse, error) {
...
func (_m *StorageDriver) DeleteFileShare(ctx context.Context, in *file.DeleteFileShareRequest) (*file.DeleteFileShareResponse, error) {
...
func (_m *StorageDriver) GetFileShare(ctx context.Context, fs *file.GetFileShareRequest) (*file.GetFileShareResponse, error) {
	ret := _m.Called(ctx, fs)
...
func (_m *StorageDriver) ListFileShare(ctx context.Context, fs *file.ListFileShareRequest) (*file.ListFileShareResponse, error) {
	ret := _m.Called(ctx, fs)
...
func (_m *StorageDriver) UpdatefileShare(ctx context.Context, fs *file.UpdateFileShareRequest) (*file.UpdateFileShareResponse, error) {
	ret := _m.Called(ctx, fs)
